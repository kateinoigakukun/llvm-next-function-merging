...
;
; RUN: %opt -S --passes="multiple-func-merging,default<Oz>" --multiple-func-merging-only=decode_mcu_AC_refine --multiple-func-merging-only=decode_mcu_AC_first -o %t.mfm.ll %s
; RUN: %opt -S --passes="func-merging,default<Oz>" --func-merging-only=decode_mcu_AC_refine --func-merging-only=decode_mcu_AC_first -o %t.fm.ll %s
