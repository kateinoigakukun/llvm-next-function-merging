...
; CHECK-MFM:      Function:        __msa_merge___msa_merge_glist_add_float64_glist_add_float32_glist_add_int32
; CHECK-MFM-NEXT: Args:
; CHECK-MFM-NEXT:   - Function:        __msa_merge_glist_add_float64_glist_add_float32
; CHECK-MFM-NEXT:   - Function:        glist_add_int32
...
; CHECK-F3M:      Function:        __fm_merge___fm_merge_glist_add_float64_glist_add_float32_glist_add_ptr
; CHECK-F3M-NEXT: Args:
; CHECK-F3M-NEXT:   - Function:        __fm_merge_glist_add_float64_glist_add_float32
; CHECK-F3M-NEXT:   - Function:        glist_add_ptr
