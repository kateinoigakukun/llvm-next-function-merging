...
; F3M-LABEL: define internal i64 @__fm_merge_Bfunc_Afunc(i1 %discriminator, ptr %m.P.P, ptr %m.Q.Q) {
; F3M-NEXT:  entry:
; F3M-NEXT:    store i32 4, ptr %m.P.P, align 4
; F3M-NEXT:    store i32 6, ptr %m.Q.Q, align 4
; F3M-NEXT:    %switch.select = select i1 %discriminator, i64 0, i64 42
; F3M-NEXT:    ret i64 %switch.select
; F3M-NEXT:  }

; CHECK-LABEL: define internal i64 @__mf_merge_Bfunc_Afunc(i1 %discriminator, ptr %m.P.P, ptr %m.Q.Q) {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    store i32 4, ptr %m.P.P, align 4
; CHECK-NEXT:    store i32 6, ptr %m.Q.Q, align 4
