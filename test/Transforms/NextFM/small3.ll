...
; CHECK-LABEL: define internal i64 @__fm_merge___fm_merge_Cfunc_Afunc_Bfunc(i1 %discriminator, i1 %m.discriminator, ptr %m.m.P.P.P, ptr %m.m.Q.Q.Q) {
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    store i32 %switch.select5, ptr %m.m.P.P.P, align 4
; CHECK-NEXT:    store i32 6, ptr %m.m.Q.Q.Q, align 4
; CHECK-NEXT:    store i32 6, ptr %m.m.Q.Q.Q, align 4
; CHECK-NEXT:    store i32 6, ptr %m.m.Q.Q.Q, align 4
; CHECK-NEXT:    store i32 6, ptr %m.m.Q.Q.Q, align 4
