...
; F3M-LABEL: define internal i64 @__fm_merge_Bfunc_Afunc(i1 %discriminator, i32* %m.P.P, i32* %m.Q.Q, i32* %m.R.R, i32* %m.S.S) {
; F3M-NEXT:  entry:
...
; CHECK-NEXT:      i2 1, label %bb.select.values.Bfunc5
