; RUN: %opt --passes="mergefunc,multiple-func-merging" -func-merging-explore=1 -pass-remarks-output=%t.mfm2-hyfm.yaml -pass-remarks-filter=multiple-func-merging --multiple-func-merging-whole-program=true --multiple-func-merging-coalescing=false --multiple-func-merging-hyfm-nw -multiple-func-merging-hyfm-profitability=true -o %t.mfm2-hyfm.bc %s
; RUN: %opt --passes="mergefunc,multiple-func-merging" -func-merging-explore=2 -pass-remarks-output=%t.mfm3-hyfm.yaml -pass-remarks-filter=multiple-func-merging --multiple-func-merging-whole-program=true --multiple-func-merging-coalescing=false --multiple-func-merging-hyfm-nw -multiple-func-merging-hyfm-profitability=true -o %t.mfm3-hyfm.bc %s
